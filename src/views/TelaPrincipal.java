...
public class TelaPrincipal extends javax.swing.JFrame {
   ...
   private void initMaximized(){
    ...
    private void initComponents() {
        ...
        jMenuItem3.setText("Cadastro Carro");
        ...
        jMenuItem5.setText("Criar Serviço");
        ...
        jMenu4.setText("Painel de Controle");
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        pega();
        this.add(cadastroUsuario);
        cadastroMecanico.dispose();
        try {
             cadastroUsuario.setMaximum(true);
                } catch (PropertyVetoException ex) {
        }
        cadastroUsuario.setVisible(true);
        cadastroUsuario.setLocation(0,35);
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        pega();
        cadastroUsuario.dispose();
        this.add(cadastroMecanico);      
        try {
             cadastroMecanico.setMaximum(true);
                } catch (PropertyVetoException ex) {
        }
        cadastroMecanico.setLocation(0, 35);     
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        pega(); 
            this.add(cadastraCarro);
            try {
             cadastraCarro.setMaximum(true);
                } catch (PropertyVetoException ex) {
        }
            cadastraCarro.setVisible(true);
            cadastraCarro.setLocation(0,35);
